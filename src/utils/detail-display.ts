...
const exactLabels: Record<string, string> = {
  ...
  is_active: 'Status',
  roles: 'Peran',
  contextual_roles: 'Peran per Kelompok Kategori',
  access: 'Hak Akses',
  companies: 'Perusahaan',
  system_roles: 'Peran Sistem (Global)',
  locations: 'Lokasi',
  category_groups: 'Kelompok Kategori',
  company_code: 'Kode Perusahaan',
  company_name: 'Perusahaan',
  category_group_code: 'Kode Kelompok Kategori',
  category_group_name: 'Kelompok Kategori',
  ...
  category_group_count: 'Jumlah Kelompok Kategori',
  lot_count: 'Jumlah Lot / Batch',
  lots: 'Rincian Lot / Batch',
